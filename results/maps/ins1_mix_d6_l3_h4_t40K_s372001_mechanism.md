...
model's maximal map JSON** (`results/maps/ins1_mix_d6_l3_h4_t40K_s372001.json`). Model type:
ADD, SUB, NEG. Config: n_digits=6, n_layers=3, n_heads=4,
n_ctx=22.
...
| `ND` | P16L0H1, P17L0H1, P18L0H1, P19L0H1, P20L0H1, P15L0H2, P16L0H2, P17L0H2, P18L0H2, P19L0H2, P20L0H2 |
...
- `MD` and `ND` share **11** node(s)
- `ND` and `SA` share **11** node(s)
