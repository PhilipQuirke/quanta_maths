...
from QuantaMechInterp import UsefulNodeList, NodeLocation, token_to_char, tokens_to_string, sort_unique_digits, QType, get_quanta_attention, get_quanta_impact, MATH_SUB_SHADES, MATH_ADD_SHADES

from quanta_maths import make_maths_tricase_questions
from quanta_maths.maths_config import MathsConfig
from quanta_maths.maths_constants import MathsToken, MathsBehavior
from quanta_maths.maths_utilities import set_maths_vocabulary, int_to_answer_str, tokens_to_unsigned_int
...
from quanta_maths.MathsTestQuestions import make_maths_s0_questions_and_answers, make_maths_s1_questions_and_answers, make_maths_s2_questions_and_answers, make_maths_s3_questions_and_answers, make_maths_s4_questions_and_answers, make_maths_s5_questions_and_answers
from quanta_maths.MathsTestQuestions import make_maths_m0_questions_and_answers, make_maths_m1_questions_and_answers, make_maths_m2_questions_and_answers, make_maths_m3_questions_and_answers
from quanta_maths.MathsTestQuestions import make_maths_n1_questions_and_answers, make_maths_n2_questions_and_answers, make_maths_n3_questions_and_answers, make_maths_n4_questions_and_answers
from quanta_maths.maths_complexity import get_maths_min_complexity
from quanta_maths.maths_search_mix import (
...
class TestMaths(unittest.TestCase):
    ...
    def test_get_math_subtask_search(self):
        ...
        tag = add_stc_functions.tag(2)
        self.assertEqual(tag, "A2.STC")
        filters = add_stc_functions.prereqs(cfg, 14, 2)
