...
def load_model(model_name):
    ...
    Kept for backward-compatibility with the many scripts that do
    ``from scripts.confirm_st_node import load_model``. Falls back to name-parsed
    config if the _train.json is unreachable (e.g. offline runs).
    """
